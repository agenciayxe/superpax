	...
	<section class="py-8">
		<div class="container mx-auto px-4">
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 my-6">
				<div class="bg-white border-red-700 border-2 rounded-xl p-6">
					<h4 class="text-gray-700 text-lg font-medium">INSTITUCIONAL</h4>
					<ul>
						<li><a href="<?php echo get_bloginfo('home'); ?>" class="text-red-700 hover:text-red-800 font-bold text-lg block my-2">Home</a></li>
						<li><a href="<?php echo get_page_link(InfoVar::show('sobre')); ?>" class="text-red-700 hover:text-red-800 font-bold text-lg block my-2">A Redeconomia</a></li>
						<li><a href="<?php echo get_page_link(InfoVar::show('privacidade')); ?>" class="text-red-700 hover:text-red-800 font-bold text-lg block my-2">Política de Privacidade</a></li>
					</ul>
				</div>
				<div class="bg-white border-red-700 border-2 rounded-xl p-6">
					<h4 class="text-gray-700 text-lg font-medium">NOSSOS LINKS</h4>
					<ul>
						<li><a href="<?php echo get_page_link(InfoVar::show('encarte')); ?>" class="text-red-700 hover:text-red-800 font-bold text-lg block my-2">Encarte</a></li>
						<li><a href="<?php echo get_post_type_archive_link('dicas'); ?>" class="text-red-700 hover:text-red-800 font-bold text-lg block my-2">Dicas & Receitas</a></li>
						<li><a href="<?php echo get_page_link(InfoVar::show('promocoes')); ?>" class="text-red-700 hover:text-red-800 font-bold text-lg block my-2">Ações</a></li>
					</ul>
				</div>
				<div class="bg-white border-red-700 border-2 rounded-xl p-6">
					<h4 class="text-gray-700 text-lg font-medium">CONTATO</h4>
					<ul>
						<li><a href="<?php echo get_page_link(InfoVar::show('lojas')); ?>" class="text-red-700 hover:text-red-800 font-bold text-lg block my-2">Lojas</a></li>
						<li><a href="<?php echo get_page_link(InfoVar::show('trabalhe')); ?>" class="text-red-700 hover:text-red-800 font-bold text-lg block my-2">Trabalhe Conosco</a></li>
						<li><a href="<?php echo get_page_link(InfoVar::show('contato')); ?>" class="text-red-700 hover:text-red-800 font-bold text-lg block my-2">Contato</a></li>
					</ul>
				</div>
				<div class="bg-white border-red-700 border-2 rounded-xl p-6">
					<h4 class="text-gray-700 text-lg font-medium">UTILITÁRIOS</h4>
					<ul>
						<li><a href="<?php echo InfoVar::show('cartao'); ?>" class="text-red-700 hover:text-red-800 font-bold text-lg block my-2">Cartão</a></li>
						<li><a href="<?php echo InfoVar::show('radio'); ?>" class="text-red-700 hover:text-red-800 font-bold text-lg block my-2">Rádio</a></li>
						<li><a href="<?php echo get_page_link(InfoVar::show('churrascometro')); ?>" class="text-red-700 hover:text-red-800 font-bold text-lg block my-2">Churrascômetro</a></li>
					</ul>
				</div>
			</div>
			<div class="bg-white border-red-700 border-2 rounded-xl py-2 px-6 my-4 md:mt-0">
