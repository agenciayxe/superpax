...
function formContactMail($id) {
    ...
    if ($quantityBooking == 1 && $quantityUser == 1) {
        ...
        <div style="font-size: 18px; font-family: \'Arial\', \'trebuchet MS\'; margin: 0px auto; width: 600px; " width="600">
            ...
            <div>
                <div>
                    ...
                    <p>Os dados foram enviados no dia ' .  strftime("%d/%m/%Y às %H:%M", strtotime($bookingCurrent->date_created)) . '</p>
                    <h3>Produtos</h3>';
        ...
        ';
        $destinatario = array('contato@supermercadosgrandmarche.com.br', 'fabio@yxe.com.br', 'rodrigo@yxe.com.br');
        $assunto = 'Grand Marchê - Contato (Site)';
        $headers = array(
