<?php 
/*
Template name: Lâmina (Vila da Penha)
*/
get_header(); 
		...
		if ($enQuery->have_posts()) {
			while ($enQuery->have_posts()) {
				...
				if (get_field('pdf')) {
					...
					?><div class="d-flex justify-content-center"><a href="<?php echo $encarteArquivo; ?>" target="_blank"><button class="button-contato">Download do Lâmina - Vila da Penha</button></a></div><?php
				}
			?>
