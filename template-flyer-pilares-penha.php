<?php 
/*
Template name: Lâmina (Pilares e Penha)
*/
get_header(); 
		...
		if ($enQuery->have_posts()) {
			while ($enQuery->have_posts()) {
				...
				if (get_field('pdf')) {
					...
					?><div class="d-flex justify-content-center"><a href="<?php echo $encarteArquivo; ?>" target="_blank"><button class="button-contato">Download do Lâmina - Vila da Penha e PIlares</button></a></div><?php
				}
			?>
			<div class="text-center d-flex justify-content-center align-items-center">
		    	<div class="swiper-button-prev"></div><div class="swiper-pagination"></div><div class="swiper-button-next"></div>
		    </div>
			<p class="text-center"><small>Ofertas válidas somente para as unidades de Vila da Penha e Pilares.</small></p>
